...
if (typeof this.PrintAppShopify === 'undefined') {
    ...
    this.PrintAppShopify = class {
        ...
        static SELECTORS = {
            previews: '.product__media-wrapper,.product-information__media,media-gallery,.image,#product-photo-container,.product-left-column,.main-image,.product-photo-container,.featured,#image-block,.product-single-photos,.product_slider,#product-image,.photos,.product-single__photos,.image__container,.product-gallery',
